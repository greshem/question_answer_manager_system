...
if (isset ( $_POST ['username'] ) && isset ( $_POST ['password']))
 {
	...
	if ($username == "" || $password == "" || $status == "")
		...
		if (mysql_num_rows ( queryMysql ( "SELECT * FROM user
			...
			queryMysql ( "INSERT INTO user(account,nickname,bind_account, password,email,status,remark) VALUES('$username','nickname','bind_account', '$password','$email','$status','$remark')" );
			$error = "用户创建成功";
